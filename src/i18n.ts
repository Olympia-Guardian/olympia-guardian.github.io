...
const STR = {
  ...
  dbLoading: {
    fr: "Chargement de la base des collections…",
    en: "Loading the collections database…",
  },
  allAbsent: {
  ...
  heroTitle: {
    fr: "Complétez vos collections ensemble",
    en: "Complete your collections together",
  },
  heroBody: {
  ...
  adminHealthLodestone: {
    fr: "Échecs de lecture du Lodestone",
    en: "Lodestone read failures",
  },
  ...
  marketScopeRegion: {
    fr: "Toute la région : {region}",
    en: "Whole region: {region}",
  },
  ...
  marketSearch: {
    fr: "Chercher parmi {n} objets manquants",
    en: "Search across {n} missing items",
  },
  marketSearching: {
    fr: "Recherche des prix… {fait}/{total}",
    en: "Fetching prices… {fait}/{total}",
  },
  ...
  marketWorldLine: {
    fr: "{n} objets · {total} gils",
    en: "{n} items · {total} gil",
  },
  marketNothing: {
  ...
  bindProfileLink: {
    fr: "Ouvrir mes réglages Lodestone ↗",
    en: "Open my Lodestone settings ↗",
  },
  bindVerify: { fr: "Vérifier", en: "Verify" },
  bindVerified: {
    fr: "✓ Personnage vérifié ! C'est ton perso.",
    en: "✓ Character verified! It's yours.",
  },
  ...
  bindError: {
    fr: "Erreur, réessaie dans un instant.",
    en: "Error, retry in a moment.",
  },
  saveError: {
    fr: "Sauvegarde impossible, réessaie.",
    en: "Could not save, retry.",
  },
  ...
  relicShapeGaro: {
    fr: "{sets} sets × 5 pièces",
    en: "{sets} sets × 5 pieces",
  },
  ...
  relicCheck: {
    fr: "clique pour marquer comme obtenue",
    en: "click to mark as obtained",
  },
  ...
  panelRemove: {
    fr: "✗ Retirer de ma collection",
    en: "✗ Remove from my collection",
  },
  ...
  createGroupChar: {
    fr: "Créer avec le personnage",
    en: "Create with character",
  },
  createGroupNoChar: {
  ...
  syncForceDone: {
    fr: "Fiche Lodestone actualisée ✓",
    en: "Lodestone profile refreshed ✓",
  },
  syncForceAlready: {
  ...
  suggestionsEmpty: {
    fr: "Aucune suggestion en attente.",
    en: "No pending suggestions.",
  },
  ...
  addOwnCell: {
    fr: "Cocher {what} dans mon journal",
    en: "Check {what} in my journal",
  },
  ...
  allHereTitle: {
    fr: "Remettre tout le monde présent",
    en: "Mark everyone as present",
  },
  ...
  refreshMember: {
    fr: "Actualiser depuis FFXIV Collect",
    en: "Refresh from FFXIV Collect",
  },
  ...
  addHintPre: {
    fr: "L'ID est dans l'URL de ta fiche",
    en: "The ID is in your profile URL on the",
  },
  syncedAgo: {
    fr: "Fiche FFXIV Collect, synchronisé {when}",
    en: "FFXIV Collect profile, synced {when}",
  },
  today: { fr: "aujourd'hui", en: "today" },
  yesterday: { fr: "hier", en: "yesterday" },
  daysAgo: { fr: "il y a {n} j", en: "{n} d ago" },
  playerNote: {
    fr: "Collections à renseigner dans « Mon Journal »",
    en: "Collections to fill in from “My Journal”",
  },
  playerNoteTitle: {
  ...
  // Planning
  scopeInstances: {
    fr: "Instances (à faire ensemble)",
    en: "Instanced (run together)",
  },
  ...
  minMissingN: {
    fr: "Manque à ≥ {n} joueurs",
    en: "Missing for ≥ {n} players",
  },
  includeUnavailable: {
    fr: "Inclure les inobtenables (event, boutique…)",
    en: "Include unobtainable (events, store…)",
  },
  ...
  searchPlanning: {
    fr: "Rechercher un contenu ou un objet…",
    en: "Search content or items…",
  },
  ...
  friendRequestWants: {
    fr: "souhaite t’ajouter en contact",
    en: "wants to add you as a contact",
  },
  ...
  newsMore: {
    fr: "+ {n} autres dans la collection",
    en: "+{n} more in the collection",
  },
  // Page de connexion
  ...
  loginPrivacyTitle: {
    fr: "Ce qu’on garde de toi",
    en: "What we keep about you",
  },
  loginPrivacyBody: {
  ...
  accountCharsManage: {
    fr: "Gérer mes personnages",
    en: "Manage my characters",
  },
  ...
  accountImportUnknown: {
    fr: "{n} ignorés (inconnus de nos catalogues)",
    en: "{n} skipped (unknown to our catalogues)",
  },
  ...
  accountError: {
    fr: "Échec : fichier illisible ou serveur injoignable.",
    en: "Failed: unreadable file or unreachable server.",
  },
  ...
  wishRemoveTitle: {
    fr: "Retirer de ma liste de souhaits",
    en: "Remove from my wishlist",
  },
  ...
  contactPendingInTitle: {
    fr: "Demandes reçues ({n})",
    en: "Received requests ({n})",
  },
  contactPendingOutTitle: {
    fr: "Demandes envoyées ({n})",
    en: "Sent requests ({n})",
  },
  contactCancel: { fr: "Annuler", en: "Cancel" },
  contactBlockedTitle: {
    fr: "Comptes bloqués ({n})",
    en: "Blocked accounts ({n})",
  },
  groupAccounts: { fr: "Comptes :", en: "Accounts:" },
  contactAddFromGroup: {
    fr: "Ajouter {name} en contact",
    en: "Add {name} as a contact",
  },
  contactAlreadyChip: { fr: "Déjà en contact", en: "Already a contact" },
  contactPendingChip: { fr: "Demande envoyée", en: "Request sent" },
  contactAlready: {
    fr: "Tu es déjà en contact avec {name}.",
    en: "You are already contacts with {name}.",
  },
  contactPending: {
    fr: "Demande de contact envoyée à {name}.",
    en: "Contact request sent to {name}.",
  },
  contactPendingIn: {
  ...
  contactAsk: {
    fr: "Ajouter {name} à tes contacts ?",
    en: "Add {name} as a contact?",
  },
  ...
  adminError: {
    fr: "Espace admin indisponible.",
    en: "Admin space unavailable.",
  },
  adminReload: { fr: "Recharger", en: "Reload" },
  adminPurge: {
    fr: "Purger les sessions expirées",
    en: "Purge expired sessions",
  },
  adminPurgeTitle: {
  ...
  adminTileChars: {
    fr: "persos vérifiés / suivis",
    en: "verified / tracked characters",
  },
  adminTileGroups: {
    fr: "groupes online / total",
    en: "online / total groups",
  },
  adminTileSessions: { fr: "sessions actives", en: "active sessions" },
  adminTileSuggestions: {
    fr: "suggestions en attente",
  ...
  tileArmoires: {
    fr: "pièces d'armoire à récupérer",
    en: "armoire pieces to get",
  },
  ...
  planningEmpty: {
    fr: "Rien à farmer avec ces filtres, collection complète ? 🎉",
    en: "Nothing to farm with these filters, collection complete? 🎉",
  },
  ...
  showMoreItems: {
    fr: "Afficher les {n} autres objets",
    en: "Show the {n} other items",
  },
  showMore: { fr: "Afficher plus ({n} restants)", en: "Show more ({n} left)" },
  hvTitle: {
    fr: "Achetable en hôtel des ventes",
    en: "Buyable on the market board",
  },
  ...
  openOnCollect: {
    fr: "ouvrir « {what} » sur FFXIV Collect ↗",
    en: 'open "{what}" on FFXIV Collect ↗',
  },
  ...
  ownsNot: {
    fr: "{who} ne possède pas {what}",
    en: "{who} does not own {what}",
  },
  matrixEmpty: {
    fr: "Aucun objet ne correspond à ces filtres.",
    en: "No item matches these filters.",
  },
  ...
  seeOnCollect: {
    fr: "Voir sur FFXIV Collect ↗",
    en: "View on FFXIV Collect ↗",
  },
  ...
  relicGlobal: {
    fr: "Avancement global, toutes les reliques",
    en: "Overall progress, all relics",
  },
  ...
  relicShapeN: {
    fr: "{steps} étapes × {jobs} jobs",
    en: "{steps} steps × {jobs} jobs",
  },
  ...
  relicShapeNArmor: {
    fr: "{steps} paliers × {jobs} pièces",
    en: "{steps} tiers × {jobs} pieces",
  },
  ...
  relicGrandTotal: {
    fr: "💰 LE GROS TOTAL de tout ce qui reste",
    en: "💰 The BIG total of everything left",
  },
  relicMatCurrency: { fr: "💰 Monnaies", en: "💰 Currencies" },
  relicMatItems: { fr: "📦 Objets", en: "📦 Items" },
  relicMatDrops: { fr: "🎲 Drops & divers", en: "🎲 Drops & misc" },
  relicTotals: {
    fr: "Total des objets restants par joueur",
    en: "Total remaining items per player",
  },
  relicCostNote: {
...
const KIND_LABELS: Record<
  Kind,
  Record<"label" | "one" | "short", Record<Lang, string>>
> = {
  mounts: {
