 ...
 *  ne les voie. La hauteur, elle, est reservee des le premier rendu par le CSS,
 *  sinon les pages s'empilent et paraissent toutes proches du regard. */
function PageAlbum({
  label,
  cells,
  isEx,
        ...
        {cells.map((it, slot) => {
          ...
          return (
            <button
              ...
              onClick={() => onItemClick(it)}
            >
              {/* Pas d'image tant que la page n'approche pas : la case garde sa
                  taille, rien ne saute au moment ou l'image arrive. */}
              {vu && <img src={it.image} alt="" loading="lazy" onError={onItemImgError} />}
